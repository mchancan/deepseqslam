...
- **(Mar 3, 2021)** Archive ML4AD [release](https://github.com/mchancan/deepseqslam/releases/tag/v1.0-beta) and update `README.md` with new Gardens Point dataset [link](https://doi.org/10.5281/zenodo.4561862).
